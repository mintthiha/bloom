...
/** Profile-page card for creating and deleting merchant → category auto-categorization rules. */
export function CategorizationRulesManager() {
  ...
  /** Loads the user's saved rules on mount. */
  useEffect(() => {
    let cancelled = false;
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            fontSize: "13px",
            fontWeight: 700,
            cursor: !isFormValid || saving || loading ? "not-allowed" : "pointer",
            opacity: !isFormValid || saving || loading ? 0.45 : 1,
            whiteSpace: "nowrap",
            flexShrink: 0,
          }}
        >
