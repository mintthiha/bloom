...
/** Renders the calendar header, legend, and month-grouped occurrence list. */
    ...
    >
      <div style={{ marginBottom: "18px" }}>
        ...
        <p style={{ color: "var(--text-secondary)", fontSize: "13px" }}>
          Upcoming occurrences from your active recurring rules.
        </p>
      </div>
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          border: `1px solid ${occurrence.status !== "upcoming" ? dotColor + "44" : "var(--border)"}`,
                          borderRadius: "10px",
                          padding: "10px 12px",
                          display: "flex",
                          alignItems: "center",
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          >
                            <span style={{ fontSize: "11px", color: "var(--text-muted)" }}>
                              ...
                              {" · "}
                              {FREQUENCY_LABEL[occurrence.rule.frequency] ?? occurrence.rule.frequency}
                            </span>
                            {badge && (
                              <span
                                style={{
