            ...
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "12px" }}>
              <thead>
                <tr>
                  {["Date", "Type", "Amount", "Category", "Merchant", "Description", ""].map(h => (
                    <th key={h} style={{
                      textAlign: "left", padding: "6px 8px", color: "var(--text-muted)", fontWeight: 600,
              ...
              <tbody>
                {paginatedRows.map((row, i) => {
                  ...
                  const isEditingCategory = editingCell?.index === absoluteIndex && editingCell.field === "category";
                  const isEditingMerchant = editingCell?.index === absoluteIndex && editingCell.field === "merchant";

                  return (
                    <tr key={absoluteIndex} style={{ background: row.error ? "#f8717108" : "transparent" }}>
                      ...
                      <td
                        style={{ padding: "7px 8px", whiteSpace: "nowrap", cursor: isEditingCategory ? "default" : "pointer" }}
                        onClick={() => !isEditingCategory && startEdit(absoluteIndex, "category", row.category ?? "")}
                      ...
                      <td
                        style={{ padding: "7px 8px", whiteSpace: "nowrap", cursor: isEditingMerchant ? "default" : "pointer" }}
                        onClick={() => !isEditingMerchant && startEdit(absoluteIndex, "merchant", row.merchant ?? "")}
            ...
            <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: "12px", marginTop: "12px" }}>
              <button
                ...
                style={{
                  ...
                  borderRadius: "7px", fontSize: "12px", fontWeight: 600, color: "var(--text-primary)",
